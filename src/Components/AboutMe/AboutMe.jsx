  ...
  return (
    <div className="component-aboutMe">
      ...
      <p>
        ...
        nuevos proyectos, aprender más, mejorar mis habilidades y conocer gente.
      </p>
      <h1>¿Qué hago?</h1>
      <p>
        Actualmente realizo proyectos para seguir mejorando mis habilidades como
        programador aprendiendo nuevas tecnologías.
      </p>
    </div>
  );
};
